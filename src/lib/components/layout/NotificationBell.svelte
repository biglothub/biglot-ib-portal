...
<div class="notification-bell relative">
	...
	{#if open}
		<div class="absolute right-0 z-50 mt-2 max-h-96 w-[calc(100vw-2rem)] overflow-y-auto rounded-xl border border-dark-border bg-dark-surface shadow-xl sm:w-80">
