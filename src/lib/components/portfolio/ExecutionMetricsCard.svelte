<script lang="ts">
	...
	const rColor = $derived(
		metrics.rMultiple == null ? 'text-gray-500' :
	...
	const effColor = $derived(
		metrics.executionEfficiency == null ? 'text-gray-500' :
...
<div class="card">
	<p class="text-xs text-gray-500 uppercase tracking-wider mb-3">Execution Metrics</p>
	<div class="grid grid-cols-2 gap-3">
		<!-- R-Multiple -->
		<div>
			<p class="text-[10px] text-gray-500 uppercase tracking-wider">R-Multiple</p>
		...
		<div>
			<p class="text-[10px] text-gray-500 uppercase tracking-wider">Efficiency</p>
		...
		<!-- Planned Risk -->
		<div>
			<p class="text-[10px] text-gray-500 uppercase tracking-wider">Planned Risk</p>
		...
		<!-- Planned Reward -->
		<div>
			<p class="text-[10px] text-gray-500 uppercase tracking-wider">Planned Reward</p>
			<p class="text-sm font-mono text-gray-300">
